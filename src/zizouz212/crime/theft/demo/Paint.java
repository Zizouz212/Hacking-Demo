...
public class Paint extends javax.swing.JTextPane implements ActionListener 
{
	...
	public void init() 
	{
		...
		this.setFont(new Font("Comic Sans MS", Font.BOLD, 72));
	...
	synchronized void goNext() 
	{
		...
		switch (step) 
		{
			...
			case 3:
				if (ms100 < 10)
					this.setText("You say I am malicious.");
				else if (ms100 < 20)
					this.setText("You say I am malicious. I am a virus.");
				else if (ms100 < 30)
					this.setText("You say I am malicious. I am a virus. I am spyware.");
				else if (ms100 < 40)
					this.setText("You say I am malicious. I am a virus. I am spyware. I am malware.");
				else if (ms100 > 50)
					this.nextStep();
				return;
			case 4:
